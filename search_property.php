...
if (isset($_COOKIE['user_session'])) {
    ...
    // Build the search query to get all relevant properties
    $sql_query = "SELECT * FROM properties WHERE booked = 0";
    ...
    if ($propertiesFound > 0) {
        ...
        echo "<table border='1'>";
        echo "<tr><th>Property ID</th><th>Location</th><th>Price</th><th>Home Type</th><th>Purpose</th><th>Note</th><th>Action</th></tr>";
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            // Determine the action based on the purpose of the property
            if ($purpose === 'sale' || $purpose === 'both') {
                ...
                if ($appointment) {
                    ...
                    echo "<td><a href='make_appointment.php?property_id={$row['id']}&customer_id=$User_id'>Make Appointment</a></td>";
                }
            } elseif ($purpose === 'rent') {
                echo "<td><a href='book_property.php?property_id={$row['id']}&customer_id=$User_id'>Book</a></td>";
            }
