...
echo "<h1>Search For Properties for buying</h1>\n";

// Link to view user's bookings
// echo "<p><a href='my_bookings.php?customer_id=$userId'>My Bookings</a></p>\n";
echo "<p><a href='my_appointments.php'>My appointments</a></p>\n";
echo "<p><a href='search_property_buy.php'>Browse All Properties</a></p>\n";
echo "<a href='logout.php'>Logout</a>";


// Form for searching properties
echo "<h2>Search Properties</h2>\n";
echo "<form action='search_property_buy.php' method='get'>\n";
